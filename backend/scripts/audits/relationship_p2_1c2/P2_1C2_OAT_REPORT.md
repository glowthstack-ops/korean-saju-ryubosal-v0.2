...
spec p2.1c2.v1 · calibration cal-2026-07-24.1 · lattice 5 case. **감사 전용·읽기 전용·production delta 0.** OAT 한 번에 하나·자동 clamp 없음(§5). anchor: S0(C0 0.3)·S1(C1 A0.15/P0.30)·S2(C1 A0.30/P0.15).

## 0. 불변식 게이트(§11) + coverage(§2)

- 불변식 위반: **0** (PASS)
- 검사: S0 A0.3==BASELINE · weight 하나 변경 시 비대상 축·status·count 불변
- **parameter coverage(14종): ALL COVERED**
- 자극됐으나 sensitivity 0인 param: 없음

## 0b. parameter coverage matrix(§2·§3)

> 14 mutable parameter가 모두 자극됐는지 증명 + eligible-case(kind 존재) 평균 민감도(전체 평균 희석 배제).

| parameter | exercised | nonzero | eligible_mean_|wide| |
|---|--:|:--:|--:|
| activation.HAP | 1 | ✔ | 4.08 |
| activation.CHUNG | 4 | ✔ | 19.435 |
| activation.HYEONG | 2 | ✔ | 10.1062 |
| activation.PA | 1 | ✔ | 11.66 |
| activation.HAE | 1 | ✔ | 2.3325 |
| stability.support.HAP | 1 | ✔ | 0.3 |
| stability.pressure.CHUNG | 4 | ✔ | 1.0 |
| stability.pressure.HYEONG | 2 | ✔ | 0.52 |
| stability.pressure.PA | 1 | ✔ | 0.39 |
| stability.pressure.HAE | 1 | ✔ | 0.39 |
| separation.CHUNG | 4 | ✔ | 1.0 |
| separation.HYEONG | 2 | ✔ | 0.39 |
| separation.PA | 1 | ✔ | 0.3575 |
| separation.HAE | 1 | ✔ | 0.3575 |
...
| same_PA_HAE:HAP | 13.993 | 0.0 | 0.0 |
...
| same_PA_HAE:CHUNG | 13.993 | 0.0 | 0.0 |
...
| same_PA_HAE:HYEONG | 13.993 | 0.0 | 0.0 |
...
| same_PA_HAE:PA | 13.993 | 11.66 | 11.66 |
...
| same_PA_HAE:HAE | 13.993 | 2.33 | 2.3325 |
...
| same_PA_HAE:support.HAP | -0.78 | 0.0 | 0.0 |
...
| same_PA_HAE:pressure.CHUNG | -0.78 | 0.0 | 0.0 |
...
| same_PA_HAE:pressure.HYEONG | -0.78 | 0.0 | 0.0 |
...
| same_PA_HAE:pressure.PA | -0.78 | -0.39 | -0.39 |
...
| same_PA_HAE:pressure.HAE | -0.78 | -0.39 | -0.39 |
...
| same_PA_HAE:CHUNG | 0.715 | 0.0 | 0.0 |
...
| same_PA_HAE:HYEONG | 0.715 | 0.0 | 0.0 |
...
| same_PA_HAE:PA | 0.715 | 0.355 | 0.3575 |
...
| same_PA_HAE:HAE | 0.715 | 0.355 | 0.3575 |
