...
| 12신살 방위 활용 & 삼재 | 연지 삼합 12신살 방위판(목적×신살 등급, 사용 방식 5종), 삼재=역마/육해/화개 세운(맥락 신호), 채팅 수동·능동 + 리포트 F-20b/Y-11b | `doc/v2_2/docs/18_SINSAL_DIRECTION.md` |
