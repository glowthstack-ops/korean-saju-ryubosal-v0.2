> R1-c1 전수 측정 고정본(감수 30차) — 재생성: `python scripts/risk_scoring_survey.py`
> 출력 결정적 — 본 파일과의 diff = 점수 의미 회귀 신호.

# R1-c1 위험 점수 전수 측정 — risk-score-r1.0.4-shadow
semantics cause-semantics-v3 · config b010e439c6902d29 · semantics 3a0cc513141a1c21
...
## 포화(D군 n=175): raw>1 3(1%) · raw>1.2 3 · capped=1 3
축별 cap(=1.0) 도달(A군): persistence 4(0%)
상위 10%(D군) 축 평균: occurrence 0.781, impact 0.535, exposure 0.388, persistence 0.541, compound 0.000, protection 0.050
...
## 도메인별 structural(A군) / rankable capped(D군)
  ...
  relocation     structural p50 0.160 · p90 0.250 · max 0.420 · n=102 | rankable p50 0.124 · p90 0.138 · max 0.138 · n=6
  selection      structural p50 0.256 · p90 0.521 · max 0.976 · n=61 | rankable p50 0.200 · p90 0.600 · max 0.600 · n=15
## 포화(D군 n=221): raw>1 7(3%) · raw>1.2 3 · capped=1 7
축별 cap(=1.0) 도달(A군): exposure 68(7%), persistence 4(0%)
상위 10%(D군) 축 평균: occurrence 0.737, impact 0.634, exposure 0.877, persistence 0.318, compound 0.375, protection 0.211
...
## 포화(D군 n=246): raw>1 10(4%) · raw>1.2 8 · capped=1 10
축별 cap(=1.0) 도달(A군): compound 10(1%), exposure 112(13%), persistence 4(0%)
상위 10%(D군) 축 평균: occurrence 0.698, impact 0.610, exposure 0.925, persistence 0.217, compound 0.573, protection 0.193
...
## 포화(D군 n=210): raw>1 3(1%) · raw>1.2 3 · capped=1 3
축별 cap(=1.0) 도달(A군): exposure 66(7%), persistence 4(0%)
상위 10%(D군) 축 평균: occurrence 0.748, impact 0.493, exposure 0.310, persistence 0.562, compound 0.071, protection 0.055
