> R3-b 노출 전수 측정 고정본(감수 42차 preflight 반영 — 밴드·critical conf 하한 잠정, 본 측정이 감수 재료) — 재생성: `python scripts/risk_presentation_survey.py`
> 출력 결정적 — 본 파일과의 diff = 노출 의미 회귀 신호.

# R3-b 위험 노출 전수 측정 — risk-present-r3.0.1-shadow
presentation_policy 2c26fc4ec5acd801 — 밴드(0.40/0.25/0.12)·critical conf 하한 0.5 전부 잠정(본 측정이 감수 재료)

## profile A_all_unknown — presentation 분포
  전체 episode: critical 0 · warning 0 · watch 89 · advisory 126 · none 520
  budget 선택 후: critical 0 · warning 0 · watch 21 · advisory 9 · none 0
...
## profile B_typical_confirmed — presentation 분포
  전체 episode: critical 0 · warning 4 · watch 100 · advisory 123 · none 488
  budget 선택 후: critical 0 · warning 4 · watch 21 · advisory 5 · none 0
...
## profile C_high_exposure — presentation 분포
  전체 episode: critical 0 · warning 14 · watch 103 · advisory 108 · none 428
  budget 선택 후: critical 0 · warning 14 · watch 12 · advisory 4 · none 0
...
## profile D_multi_selection — presentation 분포
  전체 episode: critical 0 · warning 15 · watch 104 · advisory 126 · none 473
  budget 선택 후: critical 0 · warning 11 · watch 13 · advisory 6 · none 0
...
## profile E_reality_linked — presentation 분포
  전체 episode: critical 0 · warning 7 · watch 95 · advisory 108 · none 491
  budget 선택 후: critical 0 · warning 7 · watch 17 · advisory 6 · none 0
...
## token guard 실측(선택 집합·프로필 C 기준)
  budget 256: tier P0_COMPACT 10 · overflow 10 · episode 보존 30/30 · 전역 dedup 절감(반복 대비) ≈2093 tokens
  budget 512: tier P0_COMPACT 10 · overflow 0 · episode 보존 30/30 · 전역 dedup 절감(반복 대비) ≈2093 tokens
  budget 1024: tier P1 1 · P2(full) 9 · overflow 0 · episode 보존 30/30 · 전역 dedup 절감(반복 대비) ≈2093 tokens
  budget 2048: tier P2(full) 10 · overflow 0 · episode 보존 30/30 · 전역 dedup 절감(반복 대비) ≈2093 tokens
  최소 표현 토큰(차트별): p50 329 · max 344
