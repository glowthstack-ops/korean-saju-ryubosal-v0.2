> R2 전수 선별 측정 고정본(감수 40차 — high 4 최종·recovery confidence=cap×context_confidence·quiet span 월 계약·budget 표·shadow_selection 49/49) — 재생성: `python scripts/risk_selection_survey.py`
> 출력 결정적 — 본 파일과의 diff = 선별 의미 회귀 신호.

# R2-b 위험 선별 전수 측정 — risk-select-r2.2.0-shadow
scoring risk-score-r1.2.2-shadow · policy e7d9795fd23c54eb · transition 49df076a0ad56cc1
...
## profile A_all_unknown — episode 형성·선별
  ...
  recovery: 산출 142 · earliest 142 · stable 6 · 사유 all_primary_causes_quiet 6 · cause_relief 218 · other_primary_cause_ongoing 8 · right_censored_quiet_span 55 · stable_month_native_only 73
...
## A-T 교운 overlay(episode 압축 이후 기준)
  ### medium(확정안) × MAX_BONUS=0.20 (교운일 w=1.0)
    [candidate] 평균 상승률 8.3% · top10 신규 진입 risk_id: CAR_REASSIGNMENT_RISK(3) · CAR_EVALUATION_SETBACK_RISK(1)
    [candidate] 민감도별 평균 상승률: high 20.0% · low 5.0% · medium 12.0%
    [episode] top10 overlap 10/10 · 신규 없음
    [episode] 대표 변경 12 · 도메인 대표 변경 5 · ownership 유지 0 · ownership override 0 · budget 선택 변경 차트 4
  ...
  ### medium(비교 0.30) × MAX_BONUS=0.30 (교운일 w=1.0)
    [candidate] 평균 상승률 12.5% · top10 신규 진입 risk_id: CAR_REASSIGNMENT_RISK(5) · MOV_RELOCATION_PRESSURE(1) · CAR_EVALUATION_SETBACK_RISK(1)
    [candidate] 민감도별 평균 상승률: high 30.0% · low 7.5% · medium 18.0%
    [episode] top10 overlap 10/10 · 신규 없음
    [episode] 대표 변경 12 · 도메인 대표 변경 5 · ownership 유지 0 · ownership override 0 · budget 선택 변경 차트 6
    [episode] cap이면 동점이었을 선택쌍(raw로 분별) 0 · 자연 raw 동점(동일 구조 병존 — novelty·key 결정) 2
    판정: episode top10 overlap ≥ 80% PASS · 신규 진입 단일 risk_id 미집중(≤2) PASS · cap 동점이 선택을 결정하지 않음(raw 정렬) PASS · ownership override = 0 PASS · low/none 항목 top10 신규 진입 0 PASS
...
## profile B_typical_confirmed — episode 형성·선별
  ...
  recovery: 산출 154 · earliest 154 · stable 6 · 사유 all_primary_causes_quiet 6 · cause_relief 235 · other_primary_cause_ongoing 8 · right_censored_quiet_span 55 · stable_month_native_only 85
  portfolio 원천: unique cause 합 226(후보 점수 합산 없음 — 진단 표 원천)
...
## B-T 교운 overlay(episode 압축 이후 기준)
  ### medium(확정안) × MAX_BONUS=0.20 (교운일 w=1.0)
    [candidate] 평균 상승률 9.1% · top10 신규 진입 risk_id: REL_PARTNER_READJUST(2) · MOV_RELOCATION_PRESSURE(1) · LEG_CONTRACT_TERMINATION_RISK(1) · CAR_EVALUATION_SETBACK_RISK(1) · CAR_REASSIGNMENT_RISK(1)
    [candidate] 민감도별 평균 상승률: high 20.0% · low 5.0% · medium 12.0%
    [episode] top10 overlap 10/10 · 신규 없음
    ...
    판정: episode top10 overlap ≥ 80% PASS · 신규 진입 단일 risk_id 미집중(≤2) PASS · cap 동점이 선택을 결정하지 않음(raw 정렬) PASS · ownership override = 0 PASS · low/none 항목 top10 신규 진입 0 PASS
  ### medium(비교 0.30) × MAX_BONUS=0.30 (교운일 w=1.0)
    [candidate] 평균 상승률 13.6% · top10 신규 진입 risk_id: REL_PARTNER_READJUST(4) · MOV_RELOCATION_PRESSURE(1) · LEG_CONTRACT_TERMINATION_RISK(1) · CAR_REASSIGNMENT_RISK(1)
    [candidate] 민감도별 평균 상승률: high 30.0% · low 7.5% · medium 18.0%
    [episode] top10 overlap 10/10 · 신규 없음
...
## profile C_high_exposure — episode 형성·선별
  ...
  recovery: 산출 150 · earliest 150 · stable 7 · 사유 all_primary_causes_quiet 7 · cause_relief 233 · other_primary_cause_ongoing 8 · right_censored_quiet_span 50 · stable_month_native_only 85
...
## C-T 교운 overlay(episode 압축 이후 기준)
  ### medium(확정안) × MAX_BONUS=0.20 (교운일 w=1.0)
    [candidate] 평균 상승률 9.1% · top10 신규 진입 risk_id: REL_PARTNER_READJUST(2) · CAR_REASSIGNMENT_RISK(1) · FIN_SETTLEMENT_DISPUTE(1)
    [candidate] 민감도별 평균 상승률: high 20.0% · low 5.0% · medium 12.0%
    [episode] top10 overlap 10/10 · 신규 없음
    [episode] 대표 변경 7 · 도메인 대표 변경 0 · ownership 유지 29 · ownership override 0 · budget 선택 변경 차트 0
    [episode] cap이면 동점이었을 선택쌍(raw로 분별) 0 · 자연 raw 동점(동일 구조 병존 — novelty·key 결정) 1
    판정: episode top10 overlap ≥ 80% PASS · 신규 진입 단일 risk_id 미집중(≤2) PASS · cap 동점이 선택을 결정하지 않음(raw 정렬) PASS · ownership override = 0 PASS · low/none 항목 top10 신규 진입 0 PASS
  ### medium(비교 0.30) × MAX_BONUS=0.30 (교운일 w=1.0)
    [candidate] 평균 상승률 13.6% · top10 신규 진입 risk_id: REL_PARTNER_READJUST(3) · CAR_REASSIGNMENT_RISK(3) · FIN_SETTLEMENT_DISPUTE(1)
    [candidate] 민감도별 평균 상승률: high 30.0% · low 7.5% · medium 18.0%
    [episode] top10 overlap 10/10 · 신규 없음
    ...
    판정: episode top10 overlap ≥ 80% PASS · 신규 진입 단일 risk_id 미집중(≤2) PASS · cap 동점이 선택을 결정하지 않음(raw 정렬) PASS · ownership override = 0 PASS · low/none 항목 top10 신규 진입 0 PASS
  ### high(비교안) × MAX_BONUS=0.20 (교운일 w=1.0)
    [candidate] 평균 상승률 9.3% · top10 신규 진입 risk_id: REL_PARTNER_READJUST(2) · CAR_REASSIGNMENT_RISK(1) · FIN_SETTLEMENT_DISPUTE(1)
    [candidate] 민감도별 평균 상승률: high 20.0% · low 5.0% · medium 12.0%
    ...
    판정: episode top10 overlap ≥ 80% PASS · 신규 진입 단일 risk_id 미집중(≤2) PASS · cap 동점이 선택을 결정하지 않음(raw 정렬) PASS · ownership override = 0 PASS · low/none 항목 top10 신규 진입 0 PASS
  ### high(비교안) × MAX_BONUS=0.30 (교운일 w=1.0)
    [candidate] 평균 상승률 13.9% · top10 신규 진입 risk_id: REL_PARTNER_READJUST(3) · CAR_REASSIGNMENT_RISK(3) · FIN_SETTLEMENT_DISPUTE(1)
    [candidate] 민감도별 평균 상승률: high 30.0% · low 7.5% · medium 18.0%
    [episode] top10 overlap 9/10 · 신규 MOV_CONTRACT_SETBACK_RISK
...
## profile D_multi_selection — episode 형성·선별
  ...
  recovery: 산출 169 · earliest 169 · stable 6 · 사유 all_primary_causes_quiet 6 · cause_relief 270 · other_primary_cause_ongoing 8 · right_censored_quiet_span 60 · stable_month_native_only 95
  portfolio 원천: unique cause 합 226(후보 점수 합산 없음 — 진단 표 원천)
...
## D-T 교운 overlay(episode 압축 이후 기준)
  ### medium(확정안) × MAX_BONUS=0.20 (교운일 w=1.0)
    [candidate] 평균 상승률 10.1% · top10 신규 진입 risk_id: MOV_RELOCATION_PRESSURE(1) · CAR_REASSIGNMENT_RISK(1) · SEL_UNWANTED_PLACEMENT(1)
    [candidate] 민감도별 평균 상승률: high 20.0% · low 5.0% · medium 12.0%
    [episode] top10 overlap 10/10 · 신규 없음
    ...
    판정: episode top10 overlap ≥ 80% PASS · 신규 진입 단일 risk_id 미집중(≤2) PASS · cap 동점이 선택을 결정하지 않음(raw 정렬) PASS · ownership override = 0 PASS · low/none 항목 top10 신규 진입 0 PASS
  ### medium(비교 0.30) × MAX_BONUS=0.30 (교운일 w=1.0)
    [candidate] 평균 상승률 15.2% · top10 신규 진입 risk_id: MOV_RELOCATION_PRESSURE(1) · CAR_REASSIGNMENT_RISK(1) · SEL_UNWANTED_PLACEMENT(1)
    [candidate] 민감도별 평균 상승률: high 30.0% · low 7.5% · medium 18.0%
    [episode] top10 overlap 10/10 · 신규 없음
...
## profile E_reality_linked — episode 형성·선별
  ...
  recovery: 산출 135 · earliest 135 · stable 6 · 사유 all_primary_causes_quiet 6 · cause_relief 215 · other_primary_cause_ongoing 8 · right_censored_quiet_span 50 · stable_month_native_only 71
  portfolio 원천: unique cause 합 226(후보 점수 합산 없음 — 진단 표 원천)
  fallback 분리 잔존 진단(같은 대상·family ≥3 — cause 상이·비인접의 fail-closed 분리, under-merge 후보군): 67
  proxy audit(risk_id static): ownership_not_applicable 14 · proxy_match 34 · proxy_mismatch 1
  proxy audit(behavioral): 후보 rank 불일치 0 · proxy였다면 대표가 달라졌을 episode 0
...
## E-T 교운 overlay(episode 압축 이후 기준)
  ### medium(확정안) × MAX_BONUS=0.20 (교운일 w=1.0)
    [candidate] 평균 상승률 8.7% · top10 신규 진입 risk_id: LEG_CONTRACT_TERMINATION_RISK(4) · CAR_REASSIGNMENT_RISK(2)
    [candidate] 민감도별 평균 상승률: high 20.0% · low 5.0% · medium 12.0%
    [episode] top10 overlap 10/10 · 신규 없음
    ...
    판정: episode top10 overlap ≥ 80% PASS · 신규 진입 단일 risk_id 미집중(≤2) PASS · cap 동점이 선택을 결정하지 않음(raw 정렬) PASS · ownership override = 0 PASS · low/none 항목 top10 신규 진입 0 PASS
  ### medium(비교 0.30) × MAX_BONUS=0.30 (교운일 w=1.0)
    [candidate] 평균 상승률 13.1% · top10 신규 진입 risk_id: LEG_CONTRACT_TERMINATION_RISK(5) · CAR_REASSIGNMENT_RISK(3)
    [candidate] 민감도별 평균 상승률: high 30.0% · low 7.5% · medium 18.0%
    [episode] top10 overlap 10/10 · 신규 없음
    [episode] 대표 변경 7 · 도메인 대표 변경 0 · ownership 유지 13 · ownership override 0 · budget 선택 변경 차트 3
    [episode] cap이면 동점이었을 선택쌍(raw로 분별) 0 · 자연 raw 동점(동일 구조 병존 — novelty·key 결정) 2
    판정: episode top10 overlap ≥ 80% PASS · 신규 진입 단일 risk_id 미집중(≤2) PASS · cap 동점이 선택을 결정하지 않음(raw 정렬) PASS · ownership override = 0 PASS · low/none 항목 top10 신규 진입 0 PASS
  ### high(비교안) × MAX_BONUS=0.20 (교운일 w=1.0)
    [candidate] 평균 상승률 9.0% · top10 신규 진입 risk_id: LEG_CONTRACT_TERMINATION_RISK(3) · CAR_REASSIGNMENT_RISK(2) · MOV_CONTRACT_SETBACK_RISK(1)
    [candidate] 민감도별 평균 상승률: high 20.0% · low 5.0% · medium 12.0%
    [episode] top10 overlap 10/10 · 신규 없음
    [episode] 대표 변경 7 · 도메인 대표 변경 0 · ownership 유지 13 · ownership override 0 · budget 선택 변경 차트 1
    [episode] cap이면 동점이었을 선택쌍(raw로 분별) 0 · 자연 raw 동점(동일 구조 병존 — novelty·key 결정) 2
    판정: episode top10 overlap ≥ 80% PASS · 신규 진입 단일 risk_id 미집중(≤2) PASS · cap 동점이 선택을 결정하지 않음(raw 정렬) PASS · ownership override = 0 PASS · low/none 항목 top10 신규 진입 0 PASS
  ### high(비교안) × MAX_BONUS=0.30 (교운일 w=1.0)
    [candidate] 평균 상승률 13.4% · top10 신규 진입 risk_id: LEG_CONTRACT_TERMINATION_RISK(4) · CAR_REASSIGNMENT_RISK(3) · MOV_CONTRACT_SETBACK_RISK(2)
    [candidate] 민감도별 평균 상승률: high 30.0% · low 7.5% · medium 18.0%
    [episode] top10 overlap 9/10 · 신규 MOV_CONTRACT_SETBACK_RISK
    [episode] 대표 변경 7 · 도메인 대표 변경 0 · ownership 유지 13 · ownership override 0 · budget 선택 변경 차트 3
    [episode] cap이면 동점이었을 선택쌍(raw로 분별) 0 · 자연 raw 동점(동일 구조 병존 — novelty·key 결정) 2
