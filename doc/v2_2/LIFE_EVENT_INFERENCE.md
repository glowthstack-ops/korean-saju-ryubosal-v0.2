...
- **CAL-R1(2026-09-21 데굴님 승인) — 연도 분산·사건 다양화·UX**: ①연도 선정은 생애 구간(사회초년기 19~25 /
  26~32 / 30대 / 40대 / 50대 이후)을 돌아가며 뽑고 이미 고른 해의 ±1년은 후순위, 동점은 최근 해(실측 결함: 동점을
  오래된 해부터 채워 1999~2006 8년 연속). ②연도별 사건은 도메인당 최대 2건·앞 연도에 덜 나온 사건 우선으로 5건.
  ③`RealityCalibrationYear.age/band_ko/hint`(이 해를 묻는 이유 — 교운/강신호 템플릿). ④화면은 발생 체크(본 목적)를
  맨 앞, 전체·영역 체감은 "더 자세히" 접힘, '해당 없음' 의미 명시. ⑤제출 응답에 사용자용 요약
  (`RealityCalibrationSubmitResult.summary`: 답한 해·확인 사건·없었던 사건·용도). 저장 구조·지문·규칙11 불변.
