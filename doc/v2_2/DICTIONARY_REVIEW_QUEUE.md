...
**2026-09-10 추가분(dict.v1.13, 미감수)**: ①사건 16종(§22-7 — good 11·caution 5, v1/v2 카탈로그·taxonomy.v2·문구 템플릿) ②표현 결 풀(§23 — 사건×십성군 행동 640문장, 12운성 채널 결과 42문장). 감수 관점: 신규 사건 signature·evidence의 명리 타당성, 십성군별 행동 문장이 사건 의미를 벗어나는지, 12운성 결과 문장이 사건과 어긋나는 조합(coda 성격). 결 풀은 점수에 영향 없음(문체 전용).
